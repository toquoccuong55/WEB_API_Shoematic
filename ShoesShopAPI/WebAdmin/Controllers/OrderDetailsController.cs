...
namespace WebAdmin.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        {
            var orderDetails = db.OrderDetails.Include(o => o.Order).Include(o => o.ProductSku);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,OrderID,ProductID,Quantity,UnitPrice")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
